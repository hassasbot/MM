...
# + FULL MarketMentorEngine & TelegramBot
# ============================================
...
#  LiquidityEngine, MarketRegimeDetector, MultiTimeframeAnalyzer – same as before, no changes)
# For brevity, they are included exactly as in the previous full version, without any omissions.
...
# ---------- SIGNAL GENERATOR (with Online AI) ----------
class SignalGenerator:
    ...
    async def generate(self, symbol: str) -> Optional[Signal]:
        ...
        if rsi_5m < 35 and mtf["trend_1h"] == "BULLISH":
            reversal_signal = True; reversal_direction = "BUY"
            logger.info(f"Reversal setup: RSI={rsi_5m:.1f}, 1h=UP → BUY")
        elif rsi_5m > 65 and mtf["trend_1h"] == "BEARISH":
            reversal_signal = True; reversal_direction = "SELL"
            logger.info(f"Reversal setup: RSI={rsi_5m:.1f}, 1h=DOWN → SELL")
...
# ---------- FULL MARKET MENTOR ENGINE (17 methods) ----------
